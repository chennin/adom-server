...
#elif defined ADOM_120p21
  #define LEVELID 0x082ff1dc
  #define EXPLVL 0x08302c34
  #define TURNCOUNTER 0x08302c38
  #define IDCOUNT 0x083091ec
  #define CHARNAME 0x082ecd24
#elif defined ADOM_120p22
  #define LEVELID 0x83011fc
  #define EXPLVL 0x8304c54
  #define TURNCOUNTER 0x8304c58
  #define IDCOUNT 0x830a184
  #define CHARNAME 0x82eed44
#elif defined ADOM_120p23
  #define LEVELID 0x0830225c
  #define EXPLVL 0x08305cb4
  #define TURNCOUNTER 0x08305cb8
  #define IDCOUNT 0x0830c270
  #define CHARNAME 0x082efd84
#elif defined ADOM_r48
  #define LEVELID 0x0833f4bc
  #define EXPLVL 0x08342580
  #define TURNCOUNTER 0x08342584
  #define IDCOUNT 0x0834a72c
  #define CHARNAME 0x0832a684
#elif defined ADOM_r49
  #define LEVELID 0x08340a7c
  #define EXPLVL 0x08343b40
  #define TURNCOUNTER 0x08343b44
  #define IDCOUNT 0x0834bcec
  #define CHARNAME 0x0832bc44
#elif defined ADOM_r51
  #define LEVELID 0x8467e5c
  #define EXPLVL 0x846af20
