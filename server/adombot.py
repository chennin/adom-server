...
def poll_hiscore():
    ...
    if ANCTOIRC == True and c.is_connected() == True:
        ...
        for key in diff_120p16:
            print key + " Version 1.2.0p16-20."
            c.privmsg(target, "\x02New high score\x02: " + key + " Version 1.2.0p16-20.")
            tweet("1.2.0p16-20", key);

        for key in diff_120p21:
            print key + " Version 1.2.0p21."
            c.privmsg(target, "\x02New high score\x02: " + key + " Version 1.2.0p21-22.")
            tweet("1.2.0p21-22", key);
